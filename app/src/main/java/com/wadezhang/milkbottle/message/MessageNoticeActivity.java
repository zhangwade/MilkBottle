...
public class MessageNoticeActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMessageNoticeAdapter = new MessageNoticeAdapter(mNoticeList);
        mRecyclerView.setAdapter(mMessageNoticeAdapter);
        autoRefresh();
    ...
    public void getLikes(int actionType){
        ...
        query.addQueryKeys("objectId,from,createdAt,content");
    ...
    public void showUserList(int actionType, List<Notice> postList){
        if(actionType == STATE_REFRESH) mNoticeList.clear();
        mNoticeList.addAll(postList);
