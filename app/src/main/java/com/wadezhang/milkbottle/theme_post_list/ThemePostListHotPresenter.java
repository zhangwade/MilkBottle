...
public class ThemePostListHotPresenter implements ThemePostListHotContract.Presenter {

    private ThemePostListHotContract.View mThemePostListHotView;
    ...
    public ThemePostListHotPresenter(ThemePostListHotContract.View view, String themeId){
        mThemePostListHotView = view;
        mThemeId = themeId;
        mThemePostListHotView.setPresenter(this);
    }
...
/*
            ...
            public void done(List<Post> list, BmobException e) {
                if(e == null){
                    if (!list.isEmpty()) {
                        ...
                        mThemePostListHotView.showToast("到底了");
    ...
    public void showPost(int actionType){
        if(actionType == STATE_REFRESH) mThemePostListHotView.updateAdapter(mPostList, 0);
        else mThemePostListHotView.updateAdapter(mPostList, 1);
    }
}
