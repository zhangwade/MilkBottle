...
public class ThemePostListHotAdapter extends RecyclerView.Adapter<ThemePostListHotAdapter.ViewHolder> {
    ...
    public ThemePostListHotAdapter(List<Post> postList){
        mPostList = postList;
    }
